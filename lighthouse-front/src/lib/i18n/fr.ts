const fr = {
  ...
  common: {
    ...
    noSubdirectories: 'Aucun sous-dossier trouvé',
    noFiles: 'Aucun fichier trouvé',
    errorLoadingDirectories: 'Erreur lors du chargement du dossier',
    ...
    crashLoop: {
      label: 'Crash loop',
      tooltip: 'Ce conteneur redémarre en boucle',
    },
  },
  ...
  auth: {
    ...
    passwordRuleTooShort: 'Doit contenir au moins {min} caractères',
    passwordRuleTooLong: 'Ne doit pas dépasser {max} caractères',
    ...
    passwordRuleSpecial: 'Doit contenir au moins un caractère spécial',
    passwordRuleWeak: 'Ne doit pas contenir de motifs faibles courants (ex: password, 12345, admin)',
  ...
  images: {
    title: 'Images',
    subtitle: 'Gérez vos images Docker',
    select: '',
    tags: 'Tags',
    imageId: 'ID',
    size: 'Taille',
    ...
    self: 'self',
    unused: 'inutilisée',
    usedByCount: 'utilisée par {n}',
    notSelectableHint: 'Les images utilisées ou self ne peuvent pas être supprimées en masse',
    remove: 'Supprimer',
    selfProtected: 'Cette image fait tourner Lighthouse et ne peut pas être supprimée',
    confirmRemove: 'Supprimer l’image',
    confirmRemoveWithName: 'Supprimer l’image {name} ?',
    inUseHint: 'Image utilisée — retirez d’abord le(s) conteneur(s)',
    removeSuccess: 'Image supprimée',
    removeFailed: 'Échec de la suppression de l’image',
    prune: 'Nettoyer',
    pruneTitle: 'Nettoyer les images inutilisées',
    pruneDescription: 'Supprimer les images qui ne sont utilisées par aucun conteneur.',
    pruneDanglingOnly: 'Images orphelines uniquement',
    pruneDanglingOnlyHint: 'Sinon, supprimer toutes les images inutilisées par un conteneur.',
    pruneSuccess: '{n} image(s) supprimée(s), {size} récupéré(s)',
    pruneFailed: 'Échec du nettoyage des images',
    noImages: 'Aucune image trouvée',
    noImagesMatch: 'Aucune image ne correspond à votre recherche',
    deleteSelected: 'Supprimer la sélection ({n})',
    imagesSelected: '{n} sélectionnée(s)',
    bulkDeleteTitle: 'Supprimer les images',
    bulkDeleteSubtitle: '{n} image(s) à supprimer',
    deleting: 'Suppression',
    deletingProgress: 'Suppression {current} / {total}',
    bulkDeleteSuccess: '{n} image(s) supprimée(s)',
    bulkDeletePartial: '{success} supprimée(s), {failed} en échec',
    bulkDeleteFailed: 'Échec de la suppression des images',
  },
  ...
  compose: {
    ...
    unsavedLeaveConfirm: 'Vous avez des modifications non enregistrées. Quitter sans enregistrer ?',
    fileSaved: 'Fichier enregistré avec succès',
    invalidComposeFile: 'Le fichier compose est invalide',
    composeTab: 'Fichier compose',
    envNew: 'nouveau',
    applyTitle: 'Appliquer les changements maintenant ?',
    applyDescription: 'Le fichier a été enregistré mais les conteneurs en cours utilisent encore l\'ancienne configuration. Redéployer le projet maintenant pour appliquer vos changements ?',
    applyNow: 'Redéployer maintenant',
    applyLater: 'Plus tard',
    conflictTitle: 'Fichier modifié ailleurs',
    conflictDescription: 'Ce fichier a été modifié depuis son ouverture. Recharger la dernière version ? Vos modifications non enregistrées dans cet onglet seront perdues.',
  ...
  settings: {
    ...
    autoUpdate: {
      ...
      countdownHour: 'h',
      countdownMinute: 'min',
      countdownSoon: 'imminent',
      cronUtcHint: 'Le planning est évalué en UTC (heure serveur) ; l\'heure affichée ci-dessus est convertie dans votre heure locale.',
  ...
  appLogs: {
    ...
    subtitle: 'Diagnostiquez le comportement de l\'application en temps réel',
    filters: 'Filtres',
    logLevel: 'Niveau de log',
    logLevelSaved: 'Niveau de log mis à jour',
    clearLevels: 'Réinitialiser les niveaux',
    searchPlaceholder: 'Rechercher dans les messages...',
    categoryPlaceholder: 'Filtrer par catégorie...',
    userPlaceholder: 'Filtrer par utilisateur...',
  ...
  logs: {
    ...
    streaming: 'Streaming...',
    containerTitle: 'Logs du conteneur',
    projectTitle: 'Logs du projet',
    searchPlaceholder: 'Rechercher dans les logs...',
    stderrOnly: 'Afficher uniquement stderr',
    timestamps: 'Afficher/masquer les horodatages',
    wrap: 'Retour à la ligne',
    pause: 'Pause',
    resume: 'Reprendre',
    waiting: 'En attente des logs...',
    paused: 'Streaming en pause',
    connected: 'En direct',
    reconnecting: 'Reconnexion...',
    disconnected: 'Déconnecté',
    goToBottom: 'Récents',
  ...
  actionLog: {
    ...
    lastActionFailed: 'Dernière action échouée',
    ...
    containerStart: 'Démarrer le conteneur',
  ...
  devTest: {
    ...
    hint: 'Après "Forcer périmé", lancez "Vérifier les MAJ" dans la page principale pour voir lighthouse-test-nginx et lighthouse-test-redis marqués comme nécessitant une mise à jour.',
  },
};
