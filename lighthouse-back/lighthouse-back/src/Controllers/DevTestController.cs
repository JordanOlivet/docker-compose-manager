...
public class DevTestController : BaseController
{
    ...
    private const string TestDirName = "tests-lighthouse";
    private const string NginxProjectDir = "lighthouse-test-nginx";
    private const string WhoamiProjectDir = "lighthouse-test-whoami";
    ...
    private const string NginxImageBackup = "ghcr.io/nginx/nginx-unprivileged:alpine-slim-lighthouse-backup";
    private const string WhoamiImageBackup = "ghcr.io/traefik/whoami:v1.11-lighthouse-backup";

    private const string NginxComposeContent = """
        name: lighthouse-test-nginx
        services:
          web:
